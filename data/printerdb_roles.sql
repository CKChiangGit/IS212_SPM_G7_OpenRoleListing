...
CREATE TABLE `roles` (
  ...
  `Create_Listing` tinyint(1) NOT NULL,
  `View_Applicant` tinyint(1) NOT NULL,
  `View_Listing` tinyint(1) NOT NULL,
  PRIMARY KEY (`Access_Rights`)
...
INSERT INTO `roles` VALUES (0,0,0,1),(1,0,1,1),(2,1,1,1);
